...
**Стиль:** Dark Glass UI (Glassmorphism на тёмной палитре)

- **Фон:** тёмный градиент `#0f0c29 → #302b63 → #24243e`
- **Акценты:** фиолетовый `#667eea → #764ba2`, розовый `#f093fb → #f5576c`
- **Карточки:** полупрозрачные `rgba(255,255,255,0.08)` + `backdrop-filter: blur`
- **Сводления:** мягкие тени + скруглённые углы (12-20px)
- **Текст:** белый + `rgba(255,255,255,0.5-0.6)` для второстепенного
- **Логотип:** `public/logo.jpg` (cringe100.jpg с бойскринжем.рф)
- **Шрифт:** системный, без кастомных
- В духе Stripe / Linear / Vercel — минимализм, свечение, слои
